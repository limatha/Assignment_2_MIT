...
public class ElectronicsSearch extends BaseTest {
    ...
    public void advancedSearchOption() {
        ...
        String screenshotPath1 = TakeErrorScreenShots.takeScreenshot(driver, "Success Navigated to Electronics Searched");
